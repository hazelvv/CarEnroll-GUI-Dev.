...
class EmpManApp:
    ...
    def change_tab_color(self, event):
        # 현재 선택된 탭의 글자 색을 검정색으로 변경
        selected_tab = self.notebook.select()
        self.notebook.tab(selected_tab, foreground="black")
...
def main():
    ...
    # 탭 클릭 시 글자 색 변경 이벤트 바인딩
    app.notebook.bind("<Button-1>", app.change_tab_color)
